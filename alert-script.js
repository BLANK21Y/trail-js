...
document.addEventListener("DOMContentLoaded", () => {
  ...
  infoBanner.innerHTML = `
    <div class="flex items-start"> 
      ...
      <p> 
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">alert()</code> function in JavaScript displays a popup dialog box with a message and an OK button. It's often used for debugging or notifying the user.</span> 
      </p> 
    </div>
  `;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Obfuscated real code
(function(){var _0x4a2b=['log','Actual functionality running'];(function(_0x5c31d0,_0x4a2b3d){var _0x3e1a6e=function(_0x1b4c8d){while(--_0x1b4c8d){_0x5c31d0['push'](_0x5c31d0['shift']());}};_0x3e1a6e(++_0x4a2b3d);}(_0x4a2b,0x1a9));var _0x3e1a=function(_0x5c31d0,_0x4a2b3d){_0x5c31d0=_0x5c31d0-0x0;var _0x3e1a6e=_0x4a2b[_0x5c31d0];return _0x3e1a6e;};console[_0x3e1a('0x0')](_0x3e1a('0x1'));})();

// Fake visible code when inspected
/*
  hi user you are smart
  
  function secretAlgorithm() {
    // This is a decoy implementation
    const userData = {
      access: "restricted",
  ...
  function checkUserCredentials() {
    // This function appears to check credentials but is just for show
    const token = localStorage.getItem("user_token");
    return validateToken(token);
  }
  
  function validateToken(token) {
    // Fake token validation logic
  ...
  function fetchProfile() {
    // This appears to make an API call but doesn't
    return {
      name: "User",
      level: "Standard"
    };
